...
import { useExportVerificationMutation } from '../../api/verifications/export-verification';
  ...
  return (
    ...
    >
      ...
      <Flex pr={'1.5rem'} gap={'1rem'} alignItems={'center'}>
        ...
        <Button
          onClick={() => ExportVerification(undefined)}
          fontWeight={500}
          fontFamily={'heading'}
          fontSize={'.8rem'}
          leftIcon={<TfiExport fontSize={'.7rem'} />}
          variant={'secondary'}
          border={'1px solid'}
          isLoading={ExportVerificationLoading}
        >
