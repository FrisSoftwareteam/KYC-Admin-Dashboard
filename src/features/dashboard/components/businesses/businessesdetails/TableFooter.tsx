...
// import { SingleBusinessFilterState } from '@/features/dashboard/store/businesses/singlebusinessFilter';
import { BusinessFilterState } from '@/features/dashboard/store/businesses/filter';

export default function TableFooter({ meta }: { meta?: IMeta }) {
  const [filter, setFilter] = useRecoilState(BusinessFilterState);
